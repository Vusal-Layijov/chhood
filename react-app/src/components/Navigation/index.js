  ...
  return (
    <div className="navbar_container">
      ...
      <div className="navbar__menuItems">
        ...
        <a href='https://www.linkedin.com/in/vusal-layijov-9a6181111/'target="_blank" rel="noopener noreferrer" className='menuItem'>LinkedIn</a>
        <a href="https://github.com/Vusal-Layijov" target="_blank" rel="noopener noreferrer" className='menuItem'>GitHub</a>
